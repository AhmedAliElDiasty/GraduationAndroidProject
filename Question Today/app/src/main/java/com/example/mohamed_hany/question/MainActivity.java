...
import com.example.mohamed_hany.question.model.Answer;
import com.example.mohamed_hany.question.model.Data;
                ...
                .getAsObject(new Data().getClass(),
                        new ParsedRequestListener<Data>() {
                            ...
                            public void onResponse(Data response) {
                                ...
                                sliderAdapter = new SliderAdapter(MainActivity.this, questions);
        ...
        AndroidNetworking.post("http://www.syntax-eg.esy.es/api/questionsByStudtents")
                ...
                .getAsJSONArray(new JSONArrayRequestListener() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        Toast.makeText(MainActivity.this,"Correct post " , Toast.LENGTH_LONG).show();
                    }

                    @Override
                    public void onError(ANError error) {
                        // handle error
                        Toast.makeText(MainActivity.this,"error post " , Toast.LENGTH_LONG).show();
                        Log.d("Data",error.getMessage());
                        Log.d("Data msg",answers.toString());
